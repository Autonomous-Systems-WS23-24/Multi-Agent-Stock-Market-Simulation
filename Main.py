...
async def main(num_investors,num_iterations):
    ...
    investors = [Investor.Investor(f"investor{i}@localhost", "1234",environment,(i%4)+1,(i%5)*1000,random.uniform(0, 1),1,stock_list,random.uniform(0.2, 1),random.uniform(0.01,1),num_iterations=num_iterations) for i in range(1, num_investors + 1)]
    tasks = []
