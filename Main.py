...
async def main(stock_list):
    ...
    investors = [Investor.Investor(f"investor{i}@localhost", "1234",environment,(i%4)+1,(i%5)*1000,risk_factors[i],1,stock_list,1,num_iterations=num_iterations) for i in range(1, num_investors + 1)]
    tasks = []
